...
export type CmsAuditContentType = "project" | "insight" | "team_member" | "page" | "settings" | "enquiry";
...
export async function getCmsAuditLog(filters: CmsAuditFilters = {}) {
  ...
  if (filters.contentType && ["project", "insight", "team_member", "page", "settings", "enquiry"].includes(filters.contentType)) { clauses.push("content_type = ?"); values.push(filters.contentType); }
