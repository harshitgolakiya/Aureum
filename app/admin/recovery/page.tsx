  ...
  return <CmsShell active="recovery" email={session.email} role={session.role} eyebrow="Governance" title="Audit & recovery">
    <div className="cms-recovery-page">
      ...
      <form className="cms-audit-filters" method="get">
        ...
        <label><span>Content type</span><select name="type" defaultValue={filters.contentType}><option value="">All types</option><option value="project">Project</option><option value="insight">Insight</option><option value="team_member">Team member</option><option value="page">Page</option><option value="settings">Settings</option><option value="enquiry">Enquiry</option></select></label>
